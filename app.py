...
if selected == "Inicio":
    ...
    with tab_carpeta:
        ...
        st.write("""
        El presente documento describe el desarrollo y evolución de nuestro Proyecto Eco, desde nuestros inicios en el año 2025 bajo el nombre de EcoPapel, hasta su transformación en un sistema integral en 2026.
        ...
        # 2. Origen
        st.markdown("#### 2. Origen del Proyecto (2025)")
        st.write("""
        ...
        # 3. Problema
        st.markdown("#### 3. Problema Detectado")
        st.write("""
        ...
        Esta falta de conocimiento práctico genera que el reciclaje sea minimizado o ignorado. Observamos que, al no comprender el proceso, las personas no se involucran activamente ni lo incorporan como un hábito.
        
        A partir de esta observación, definimos un enfoque claro: no centrarse únicamente en promover el reciclaje mediante mensajes teóricos, sino en mostrar el proceso de forma concreta. Nuestro objetivo dejó de ser decir “hay que reciclar” y pasó a ser demostrar “cómo se recicla”. De esta manera, orientamos el proyecto a la concientización a través de la práctica, utilizando la transformación real de materiales como herramienta principal para generar aprendizaje e interés en la comunidad.
        """)
        
        # 4. Desarrollo EcoPapel 2025
        st.markdown("#### 4. Desarrollo de EcoPapel 2025")
        st.write("""
        ...
        * Investigación formal sobre la historia cronológica del reciclaje de papel.
        ...
        # 5. Resultados
        st.markdown("#### 5. Resultados y Aprendizajes")
        st.write("""
        A lo largo del desarrollo de EcoPapel 2025, logramos obtener resultados concretos tanto a nivel técnico como en nuestro proceso de aprendizaje.
        ...
        Por otro lado, adquirimos conocimientos prácticos sobre el proceso de reciclaje, comprendiendo cada una de sus etapas: desde la recolección del material hasta la obtención del producto final. Este aprendizaje nos permitió pasar de un conocimiento teórico general a una comprensión real del proceso.
        
        También logramos avanzar en la comunicación del proyecto, utilizando redes sociales y estrategias de difusión para generar interés en otras personas. Esto reforzó nuestro objetivo inicial de no solo reciclar, sino también enseñar cómo hacerlo.
        ...
        # 6. Limitaciones
        st.markdown("#### 6. Limitaciones del Proyecto")
        st.write("""
        ...
        st.markdown("#### 7. Punto de Evolución")
        st.write("""
        ...
        Este punto de evolución no surgió de un momento único, sino de una acumulación de experiencias a lo largo de nuestro proceso. Al mejorar las técnicas, obtener resultados más consistentes y lograr productos funcionales, comprendimos que el proyecto podía ir más allá de una actividad puntual.
        
        Sin embargo, esta misma evolución nos permitió identificar una limitación más profunda: el proyecto funcionaba, pero no teníamos una estructura que le permitiera sostenerse en el tiempo o expandirse de manera organizada.
        
        A partir de esta reflexión, detectamos un problema más general: muchos proyectos ecológicos surgen con buenas ideas, pero terminan desapareciendo con el tiempo. No logran mantenerse activos ni generar un impacto duradero, ya sea por falta de organización, continuidad o integración con otros procesos.
        
        Este análisis nos llevó a replantear el enfoque del proyecto. Ya no se trataba únicamente de mejorar lo que estábamos haciendo, sino de cambiar la lógica del proyecto en sí. Nuestro objetivo pasó de desarrollar un proyecto funcional a diseñar un sistema capaz de mantenerse, crecer y adaptarse con el tiempo. Este cambio de perspectiva marcó el punto de evolución entre nuestro EcoPapel 2025 y lo que posteriormente se convertiría en nuestro Proyecto Eco 2026.
        """)
        
        # 8. Nacimiento del Proyecto Eco 2026
        st.markdown("#### 8. Nacimiento del Proyecto Eco 2026")
        st.write("""
        ...
        El Proyecto Eco surge con el objetivo de resolver una problemática más amplia: la falta de continuidad y sostenibilidad en los proyectos ecológicos. En lugar de desarrollar una iniciativa aislada, nos propusimos la creación de un sistema capaz de mantenerse en el tiempo y generar un impacto real.
        
        Para lograrlo, adoptamos un enfoque diferente. Pasamos de un modelo basado en actividades a un modelo estructurado, con una lógica de funcionamiento más cercana a una organización.
        """)
        ...
        * Proyección y escalabilidad a largo plazo.
        ...
        st.markdown("#### 9. Nuevo Enfoque y Objetivos")
        st.write("""
